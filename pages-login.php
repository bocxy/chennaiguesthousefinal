            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.php" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">The Chennai Guesthouse</span>
                </a>
              </div><!-- End Logo -->
...
if (form.username.value=="admin") { 
      ...
      window.open('tables-data.php') // Redirecting to other page.
return false;
                  ...
                  <form class="row g-3 needs-validation" >
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" onClick="display(this.form)" >Login</button>
