...
class Reservation {
  ...
  // (C) SAVE RESERVATION
  function save ($name, $email, $aadharno,  $paymentmode, $startdate, $enddate ,$status) {
    ...
    try {
      $this->stmt = $this->pdo->prepare(
        "INSERT INTO `crud_users` (`name`, `email`, `aadharno`, `paymentmode`, `startdate`, `enddate`, `status`) VALUES (?,?,?,?,?,?,?)"
      );
      $this->stmt->execute([$name, $email, $aadharno,  $paymentmode, $startdate, $enddate ,$status]);
...
define("DB_NAME", "programmingknowledge");
define("DB_CHARSET", "utf8");
define("DB_USER", "root");
define("DB_PASSWORD", "yazhini1998@");
